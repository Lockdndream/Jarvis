# Current Speech-to-Text Flow (pre-Groq-Whisper)

Written as Step 0 of the Groq Whisper STT upgrade (Month 1, Week 1 of the
post-F1 roadmap). Documents both client-side recognition paths as they exist
today, before any changes.
